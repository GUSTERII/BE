...
public class MaterieServiceImpl implements MaterieService {
    ...
    public MaterieDto addMaterie(CreateMaterieDto createMaterieDto) {
        ...
        Specialization specialization = specializationRepository.findByName(createMaterieDto.getDegree())
                .orElseThrow(() -> new IllegalArgumentException("Degree not found"));

        User teacher = userRepository.findByName(createMaterieDto.getTeacher())
                .orElseThrow(() -> new IllegalArgumentException("Teacher not found"));

        if (materieRepository.findByNameAndSemesterAndYearAndDegree(createMaterieDto.getName(), createMaterieDto.getSemester(), createMaterieDto.getYear(), specialization).isPresent()) {
            throw new IllegalArgumentException("Materie already exists");
        }

        Materie materie = materieRepository.save(Materie.builder()
                .name(createMaterieDto.getName())
                .semester(createMaterieDto.getSemester())
                .year(createMaterieDto.getYear())
                .specialization(specialization)
                .facultate(createMaterieDto.getFaculty() != null ?
                    facultateRepository.findByLongName(createMaterieDto.getFaculty()).orElseThrow(() -> new IllegalArgumentException("Faculty not found")) : null)
                .teacher(teacher)
        ...
        return MaterieDto.builder()
                ...
                .degree(materie.getSpecialization().getName())
    ...
    public MaterieDto addTeacher(String name, String teacher) {
        Materie materie = materieRepository.findByName(name)
        ...
        List<SubGrupa> groups = groupRepository.findBySpecializationShortNameAndStudyYear(materie.getSpecialization().getName(), String.valueOf(materie.getYear()));
    ...
    public MaterieDto getMaterieByName(String name) {
        return materieRepository.findByName(name)
                .map(materie -> MaterieDto.builder()
                        .name(materie.getName())
                        .semester(materie.getSemester())
                        .teacher(materie.getTeacher() != null ? materie.getTeacher().getName() : null)
                        .year(materie.getYear())
                        .degree(materie.getSpecialization().getName() != null ? materie.getTeacher().getEmail() : null)
                        .faculty(materie.getFacultate() != null ? materie.getFacultate().getLongName() : null)
                        .build())
                .orElseThrow(() -> new IllegalArgumentException("Materie not found"));
    }
    ...
    public MaterieDto updateMaterie(UpdateMaterieDto updateMaterieDto){
        Materie materie = materieRepository.findByName(updateMaterieDto.getOldName())
                .orElseThrow(() -> new IllegalArgumentException("Materie not found"));
        ...
        materie.setSpecialization(specializationRepository.findByName(updateMaterieDto.getDegree())
                .orElseThrow(() -> new IllegalArgumentException("Degree not found")));
        materie.setTeacher(userRepository.findByName(updateMaterieDto.getTeacher())
                .orElseThrow(() -> new IllegalArgumentException("Teacher not found")));
    ...
    public List<MaterieDto> getAll() {
        return materieRepository.findAll().stream()
                .map(toMaterieDtoList())
                .toList();
    }
    ...
    public List<MaterieDto> getMaterieByTeacher(String teacher) {
        ...
        List<Materie> materies = materieRepository.findByTeacher(teacherEntity)
                .orElseThrow(() -> new IllegalArgumentException("Materie not found"));
    ...
    private static Function<Materie, MaterieDto> toMaterieDtoList() {
        return materie -> MaterieDto.builder()
            .name(materie.getName())
            .semester(materie.getSemester())
            .teacher(materie.getTeacher() != null ? materie.getTeacher().getName() : null)
            .year(materie.getYear())
            .degree(materie.getSpecialization() != null ? materie.getSpecialization().getName() : null)
            .faculty(materie.getFacultate() != null ? materie.getFacultate().getLongName() : null)
            .examDuration(materie.getExamDuration())
            .build();
    }
